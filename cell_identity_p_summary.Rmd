...
fig1 = "figures/workflow_diagram.png"
...
fig2A = "figures/StabilityVsError_copy.png"
...
fig2B = "figures/ScreeVsStability_c_copy.png"
...
```{r, out.width="40%", fig.align="center", echo=FALSE}
fig3 = c("figures/varByFact_genes_copy.png", "figures/varByFact_components_copy.png")
...
```{r, out.width="100%", echo=FALSE}
fig4 = "figures/A_heatmaps/all.celltypes.clust_copy.png"
...
```{r, out.width="100%", echo=FALSE}
fig5 = "figures/umaps/allcellstissues_umap_ica.png"
...
fig6 = c( "figures/umaps/comp9_umap_ica.png", 
          "figures/umaps/comp67_umap_ica.png", 
          "figures/umaps/comp89_umap_ica.png", 
          "figures/umaps/comp82_umap_ica.png", 
          "figures/umaps/comp66_umap_ica.png", 
          "figures/umaps/comp69_umap_ica.png")
...
```{r, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="default", echo=FALSE}
fig7 = c( "figures/umaps/comp12_umap_ica.png", 
          "figures/umaps/comp24_umap_ica.png", 
          "figures/umaps/comp33_umap_ica.png", 
          "figures/umaps/comp22_umap_ica.png", 
          "figures/umaps/comp32_umap_ica.png", 
          "figures/umaps/comp27_umap_ica.png", 
          "figures/umaps/comp36_umap_ica.png", 
          "figures/umaps/comp47_umap_ica.png", 
          "figures/umaps/comp44_umap_ica.png")
...
```{r, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="default", echo=FALSE}
fig8 = c( "figures/umaps/comp40_umap_ica.png", 
          "figures/umaps/comp52_umap_ica.png", 
          "figures/umaps/comp63_umap_ica.png", 
          "figures/umaps/comp6_umap_ica.png", 
          "figures/umaps/comp29_umap_ica.png", 
          "figures/umaps/comp30_umap_ica.png", 
          "figures/umaps/comp15_umap_ica.png", 
          "figures/umaps/comp23_umap_ica.png", 
          "figures/umaps/comp35_umap_ica.png")
...
fig9 = "figures/beta_heatmaps/Myelo.1.betas.clust_copy.png"
...
fig10 = "figures/beta_heatmaps/Myelo.4.betas.clust_copy.png"
...
```{r, out.width="70%", fig.align="center", echo=FALSE}
fig13 = "figures/Module.sizes.weight.reuse.SD_copy.png"
...
fig14 = c("figures/module_GE_dots/Myelo.1/Myelo.1.module.40_copy.png", 
          "figures/module_GE_dots/Myelo.1/Myelo.1.module.23_copy.png", 
          "figures/module_GE_dots/Myelo.1/Myelo.1.module.36_copy.png")
...
fig15 = c("figures/module_GE_dots/Myelo.4/Myelo.4.module.52_copy.png", 
          "figures/module_GE_dots/Myelo.4/Myelo.4.module.63_copy.png")
...
fig16 = c("figures/module_GE_dots/Endo.1/Endo.1.module.9_copy.png", 
          "figures/module_GE_dots/Endo.2/Endo.2.module.67_copy.png", 
          "figures/module_GE_dots/Endo.2/Endo.2.module.82_copy.png")
...
fig17 = "figures/module_ora_gsea_tf/global.reactome.ora.ma.mi_copy.png"
...
fig18 = "figures/module_ora_gsea_tf/endothel.reactome.ora.ma.mi_copy.png"
...
fig19 = "figures/module_ora_gsea_tf/blood.reactome.ora.ma.mi_copy.png"
...
fig20 = c("figures/spec_percell_bin5_copy.png", 
          "figures/spec_pergene_bin5_copy.png")
...
fig21 = "figures/spec_heatmap_bin5_copy.png"
...
fig6 = c( "figures/module_networks/52.myelo.png", 
          "figures/module_networks/52.mac.png", 
          "figures/module_networks/52.mo.png", 
          "figures/module_networks/52.gr.png")
knitr::include_graphics(fig6)
```  
...
```{r, fig.show="hold", fig.ncol=2, out.width="50%", fig.align="default", echo=FALSE}
fig6 = c( "figures/module_networks/52.myelo.TF.png", 
          "figures/module_networks/52.mac.TF.png", 
          "figures/module_networks/52.mo.TF.png", 
          "figures/module_networks/52.gr.TF.png")
knitr::include_graphics(fig6)
```  
