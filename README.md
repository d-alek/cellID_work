...
As many other matrix factorisation models, ICA decomposes the expression of gene ![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;i=1,...,P) in cell ![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;j=1,...,N) as  
  
![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;x_{i,j}&space;=&space;\sum_{k=1}^{K}&space;s_{ik}&space;a_{kj})
Here *s~ik~* is the contribution of component *k* to gene *i* expression (and likewise the contribution of gene *i* to component *k*, if we rather focus on the component *s~∙k~* as a unique gene co-expression pattern in data); *a~kj~* is the extent of activation or usage of component *k* by cell *j*. What is specific to ICA compared to most other matrix decomposition models is that components *s~∙k~* are made maximally independent by maximising their non-Gaussianity. This feature gives them more than just decorrelation of Gaussian models and also makes them naturally sparse (Hyvärinen, 2013). We used fastICA algorithm in which non-Gaussianity is measured by negentropy (negative differential entropy), ![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;J(s)=H(z)-H(s)), which is approximated using  
  
![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;J(s)&space;=&space;[E(G(s))-E(G(z))]^2)
...
fig1 = "figs/workflow_diagram.png"
include_graphics(fig1)
```
**Figure 1. A schematic overview of our workflow:** how gene weights in *s~k~* components are used to extract modules of co-expressed genes that represent maximally independent patterns in data, and how cell weights in *a~k~^T^* components are used to find most critical combination of such modules that explain various cell identities.  
...
fig2A = "figs/StabilityVsError_copy.png"
include_graphics(fig2A)
```
...
![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;\frac{||X-SA||_2^2}{||X||_2^2})
  
```{r, out.width="40%", fig.align="center", echo=FALSE}
fig2B = "figs/ScreeVsStability_c_copy.png"
include_graphics(fig2B)
```
...
```{r, out.width="40%", fig.align="center", echo=FALSE}
fig3 = c("figs/varByFact_genes_copy.png", "figs/varByFact_components_copy.png")
...
```{r, out.width="100%", echo=FALSE}
fig4 = "figs/A_heatmaps/all.celltypes.clust_copy.png"
...
```{r, out.width="100%", echo=FALSE}
fig5 = "figs/umaps/allcellstissues_umap_ica.png"
include_graphics(fig5)
```
**Figure 5. UMAP visualisation of all cells, coloured by cell type (left) and tissues of origin (right).**  
  
  
```{r, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="default", echo=FALSE}
fig6 = c( "figs/umaps/comp9_umap_ica.png", 
          "figs/umaps/comp67_umap_ica.png", 
          "figs/umaps/comp89_umap_ica.png", 
          "figs/umaps/comp82_umap_ica.png", 
          "figs/umaps/comp66_umap_ica.png", 
          "figs/umaps/comp69_umap_ica.png")
...
```{r, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="default", echo=FALSE}
fig7 = c( "figs/umaps/comp12_umap_ica.png", 
          "figs/umaps/comp24_umap_ica.png", 
          "figs/umaps/comp33_umap_ica.png", 
          "figs/umaps/comp22_umap_ica.png", 
          "figs/umaps/comp32_umap_ica.png", 
          "figs/umaps/comp27_umap_ica.png", 
          "figs/umaps/comp36_umap_ica.png", 
          "figs/umaps/comp47_umap_ica.png", 
          "figs/umaps/comp44_umap_ica.png")
...
```{r, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="default", echo=FALSE}
fig8 = c( "figs/umaps/comp40_umap_ica.png", 
          "figs/umaps/comp52_umap_ica.png", 
          "figs/umaps/comp63_umap_ica.png", 
          "figs/umaps/comp6_umap_ica.png", 
          "figs/umaps/comp29_umap_ica.png", 
          "figs/umaps/comp30_umap_ica.png", 
          "figs/umaps/comp15_umap_ica.png", 
          "figs/umaps/comp23_umap_ica.png", 
          "figs/umaps/comp35_umap_ica.png")
...
fig9 = "figs/beta_heatmaps/Myelo.1.betas.clust_copy.png"
include_graphics(fig9)
```
...
fig10 = "figs/beta_heatmaps/Myelo.4.betas.clust_copy.png"
include_graphics(fig10)
```
...
```{r, out.width="70%", fig.align="center", echo=FALSE}
fig13 = "figs/Module.sizes.weight.reuse.SD_copy.png"
include_graphics(fig13)
```
...
```{r, fig.show="hold", fig.ncol=3, out.width=c("34%","32%","34%"), fig.align="default", echo=FALSE}
fig14 = c("figs/module_GE_dots/Myelo.1.module.40_copy.png", 
          "figs/module_GE_dots/Myelo.1.module.23_copy.png", 
          "figs/module_GE_dots/Myelo.1.module.36_copy.png")
knitr::include_graphics(fig14)
```
...
```{r, fig.show="hold", fig.ncol=2, out.width="42%", fig.align="default", echo=FALSE}
fig15 = c("figs/module_GE_dots/Myelo.4.module.52_copy.png", 
          "figs/module_GE_dots/Myelo.4.module.63_copy.png")
knitr::include_graphics(fig15)
```
...
```{r, fig.show="hold", fig.ncol=2, out.width=c("20%","40%","40%"), fig.align="default", echo=FALSE}
fig16 = c("figs/module_GE_dots/Endo.1.module.9_copy.png", 
          "figs/module_GE_dots/Endo.2.module.67_copy.png", 
          "figs/module_GE_dots/Endo.2.module.82_copy.png")
knitr::include_graphics(fig16)
```
...
```{r, out.width="85%", fig.align="right", echo=FALSE}
fig17 = "figs/module_ora_gsea_tf/global.reactome.ora.ma.mi_copy.png"
include_graphics(fig17)
```
...
```{r, out.width="95%", fig.align="right", echo=FALSE}
fig18 = "figs/module_ora_gsea_tf/endothel.reactome.ora.ma.mi_copy.png"
include_graphics(fig18)
```
...
fig19 = "figs/module_ora_gsea_tf/blood.reactome.ora.ma.mi_copy.png"
include_graphics(fig19)
```
...
![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;P(y|x)=\frac{P(x|y)P(y)}{\sum_y{P(x|y)P(y)}})  
  
1[equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;I(x)=1&plus;\sum_y{P(y|x)log_nP(y|x)})  
  
![equation](https://latex.codecogs.com/svg.latex?\fn_cm&space;Spec(y)=\sum_x{P(x|y)I(x)})  
...
```{r, fig.show="hold", fig.ncol=2, out.width="40%", fig.align="default", echo=FALSE}
fig20 = c("figs/spec_percell_bin5_copy.png", 
          "figs/spec_pergene_bin5_copy.png")
knitr::include_graphics(fig20)
```
...
fig21 = "figs/spec_heatmap_bin5_copy.png"
include_graphics(fig21)
```
...
```{r, fig.show="hold", fig.ncol=2, out.width="50%", fig.align="default", echo=FALSE}
fig6 = c( "figs/module_networks/52.myelo.png", 
          "figs/module_networks/52.mac.png", 
          "figs/module_networks/52.mo.png", 
          "figs/module_networks/52.gr.png")
knitr::include_graphics(fig6)
```  
...
```{r, fig.show="hold", fig.ncol=2, out.width="50%", fig.align="default", echo=FALSE}
fig6 = c( "figs/module_networks/52.myelo.TF.png", 
          "figs/module_networks/52.mac.TF.png", 
          "figs/module_networks/52.mo.TF.png", 
          "figs/module_networks/52.gr.TF.png")
knitr::include_graphics(fig6)
```  
